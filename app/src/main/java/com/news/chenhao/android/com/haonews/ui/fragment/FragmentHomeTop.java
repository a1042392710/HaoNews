...
public class FragmentHomeTop extends BaseFragment<HomeTopPresenter> implements IFragmentHomeTopView {
    ...
    @Override
    protected HomeTopPresenter getPresenter() {
        return new HomeTopPresenter(this,this);
    }
